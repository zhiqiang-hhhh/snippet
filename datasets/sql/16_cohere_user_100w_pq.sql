...
DROP TABLE IF EXISTS cohere_user_100w_pq;

CREATE TABLE cohere_user_100w_pq (
...
DUPLICATE KEY(user_id, id) COMMENT "100用户 x 100W向量 (768D, pq_on_disk)"
